...
def get_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="logs/train/runs/stable_diffusion_lora/2025-01-07_21-22-52/checkpoints/last.ckpt")
    # parser.add_argument("--ckpt_path", type=str, default=None)
    parser.add_argument(
        "--model_config", type=str, default="configs/model/stable_diffusion_lora.yaml"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default="outputs/stable_diffusion_lora",
    )
    ...
    parser.add_argument(
        "--feature_extractor", type=str, default="checkpoints/stablev15"
    )
