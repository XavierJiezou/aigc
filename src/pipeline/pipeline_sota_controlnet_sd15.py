...
from diffusers.loaders import FromSingleFileMixin, TextualInversionLoaderMixin, StableDiffusionLoraLoaderMixin, IPAdapterMixin
...
class StableDiffusionControlNetPipeline(
    ...
    def get_res_sample(
        ...
        expanded_timesteps = timesteps.repeat(1, expanded_encoder_hidden_states.shape[0])  # [bs, 20]
        expanded_timesteps = expanded_timesteps.squeeze(0)
        ...
        for i in range(len(down_block_res_samples)):
            ...
            res_samples = moe_list[i](res_samples)
        ...
        mid_block_res_sample_expert = moe_list[-1](mid_block_res_sample_expert)
