...
def main(gpu_index=0, random_seed=42, text_file=None, mask_dir=None, mask_range=None, output_dir=None):
    ...
    output_dir = output_dir or "data/visulization/controlnet/512"
    ...
    for mask in masks:
        ...
        # Construct command
        command = [
            "python", "src/inference/controlnet_inference.py",
            "--ckpt_path=logs/train/runs/controlnet/2024-12-18_13-02-29/checkpoints/epoch=002-val_loss=0.1412.ckpt",
