...
def get_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default="logs/train/runs/ipadapter_mask_spi/2025-01-02_17-48-54/checkpoints/epoch=049-val_loss=0.1403.ckpt")
    parser.add_argument("--model_config", type=str, default="configs/model/ipadapter_mask_spi.yaml")
    parser.add_argument("--output_dir", type=str, default="data/visulization/ipadapter_spi",)
